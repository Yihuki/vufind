 ...
 * @link     https://vufind.org Main Site
 */
class PublicSummonController extends AbstractSearch
{
    /**
     * Constructor
     *
    ...
    {
        $this->searchClassId = 'PublicSummon';
        parent::__construct($sm);
    }

    /**
     * Use preDispatch event to add PublicSummon message.
     *
     ...
     */
    public function injectPublicSummonMessage(MvcEvent $e)
    {
        $this->layout()->poweredBy
            = 'Powered by Public Summon API';
    }
    ...
    protected function attachDefaultListeners()
    {
        ...
        $events->attach(
            ...
            [$this, 'injectPublicSummonMessage'],
            1000
        );
    }
    ...
    public function advancedAction()
    {
        ...
        $view->ranges = $this
            ->getAllRangeSettings($specialFacets, $view->saved, 'PublicSummon');
