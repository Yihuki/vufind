...
class PluginManager extends \VuFind\ServiceManager\AbstractPluginManager
{
    ...
    protected $aliases = [
        ...
        'publicsummonbestbets' => PublicSummonBestBets::class,
        'publicsummondatabases' => PublicSummonDatabases::class,
        'publicsummontopics' => PublicSummonTopics::class,
    ...
    protected $factories = [
        ...
        PublicSummonBestBets::class => InjectResultsManagerFactory::class,
        PublicSummonDatabases::class => InjectResultsManagerFactory::class,
        PublicSummonTopics::class => InjectResultsManagerFactory::class,
