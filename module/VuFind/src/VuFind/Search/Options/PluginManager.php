...
class PluginManager extends \VuFind\ServiceManager\AbstractPluginManager
{
    ...
    protected $aliases = [
        ...
        'primo2' => \VuFind\Search\Primo2\Options::class,
        ...
        'publicsummon' => \VuFind\Search\PublicSummon\Options::class,
    ...
    protected $factories = [
        ...
        \VuFind\Search\Primo2\Options::class => OptionsFactory::class,
        ...
        \VuFind\Search\PublicSummon\Options::class => OptionsFactory::class,
