 ...
 * @link     https://vufind.org Main Site
 */
class Primo2BackendFactory extends AbstractBackendFactory
{
    ...
    {
        $this->setup($sm);
        $this->primoConfig = $this->getService(\VuFind\Config\ConfigManagerInterface::class)->getConfigObject('Primo2');
